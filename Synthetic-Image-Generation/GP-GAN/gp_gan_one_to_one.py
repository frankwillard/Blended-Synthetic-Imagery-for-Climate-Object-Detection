...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Creates n images blending images from src_dir and dst_dir through the GP-GAN"
    )
    parser.add_argument(
        "--src-dir",
        type=str,
        required=True,
        help="Directory (do not include the final slash) for augmented canvases/masks/labels",
    )
    parser.add_argument(
        "--dst-dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Directory (do not include the final slash) for output_images (subdir of s_src_t_target per domain combination)",
    )
    parser.add_argument(
        "--domains",
        action="append",
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help="Number of images to produce per domain combination",
    )
