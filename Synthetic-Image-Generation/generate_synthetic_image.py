...
def generate_synthetic_image(
    ...
    if generate_src_augmentations:
        ...
        raise NotImplementedError(
            "Currently only generating augmentations for the source domain is supported."
        )
    ...
    blend_with_gp_gan(
        ...
        dst_img,
        mask_img_fpath,
        blended_img_out_path=blended_img_out_path,
        verbose=verbose,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--out-fname", type=str, required=True, help="The filename of the output image."
    )
    parser.add_argument(
        "--random-seed",
        type=int,
    ...
    # GP-GAN arguments
    parser.add_argument(
        "--dst-img", type=str, required=True, help="File path for background image"
    )
    parser.add_argument(
        "--blended-img-out-path",
        type=str,
        required=True,
        help="File path to output blended synthetic image",
    )
    parser.add_argument(
        "--gp-gan-dir",
        type=str,
